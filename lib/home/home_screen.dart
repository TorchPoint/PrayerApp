...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _prayNowCategoryWidget()
  {
    return GestureDetector(
      onTap: (){
        ...
        child: CustomPrayOptionContainer(title:AppStrings.PRAY_NOW_TEXT,imagePath:AssetPaths.PRAY_NOW_IMAGE),
    );
  }
  ...
  Widget _addPrayerCategoryWidget()
  {
    return GestureDetector(
     ...
     child: CustomPrayOptionContainer(title:AppStrings.ADD_PRAYER_TEXT,imagePath:AssetPaths.ADD_PRAYER_IMAGE),
    );
  }
  ...
  Widget _bibleCategoryWidget()
  {
    return GestureDetector(
      ...
      child: CustomPrayOptionContainer(title:AppStrings.BIBLE_TEXT,imagePath:AssetPaths.BIBLE_IMAGE,imageWidth: 45.0,imageHeight: 45.0,),
    );
  }
  ...
  Widget _addPraiseCategoryWidget()
  {
    return GestureDetector(
      ...
      child: CustomPrayOptionContainer(title:AppStrings.ADD_PRAISE_TEXT,imagePath:AssetPaths.ADD_PRAISE_IMAGE,imageWidth: 70.0,imageHeight: 70.0,),
    );
  }
  ...
  Widget _prayerPartnersWithoutSubscriptionCategoryWidget()
  {
    return GestureDetector(
      ...
      child: CustomPrayOptionContainer(title:AppStrings.PRAYER_PARTNERS_TEXT,imagePath:AssetPaths.PRAYER_PARTNER_WITHOUT_SUBSCRIPTION_IMAGE),
    );
  }
  ...
  Widget _prayerGroupCategoryWidget()
  {
    return GestureDetector(
      ...
      child:CustomPrayOptionContainer(title:AppStrings.PRAYER_GROUPS_TEXT,imagePath:AssetPaths.PRAYER_GROUP_IMAGE),
    );
  }
