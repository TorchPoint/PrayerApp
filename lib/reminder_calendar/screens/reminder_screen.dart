    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: reminderIndex == currentReminderIndex ? AppColors.BUTTON_COLOR :AppColors.WHITE_COLOR,
        ...
        child: Column(
          ...
          children: [
            Text(title[reminderIndex],style: TextStyle(color: reminderIndex == currentReminderIndex ? AppColors.WHITE_COLOR :AppColors.BLACK_COLOR,fontWeight: FontWeight.w800),textScaleFactor: 1.0,maxLines: 1,overflow: TextOverflow.ellipsis,),
            SizedBox(height: 1.0,),
            Text(message[reminderIndex],style: TextStyle(color: reminderIndex == currentReminderIndex ? AppColors.WHITE_COLOR : AppColors.BLACK_COLOR,fontWeight: FontWeight.w600),textScaleFactor: 1.0),
          ],
        ),
      ),
    );
