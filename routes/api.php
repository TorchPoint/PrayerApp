...
Route::group(['middleware' => ['cors', 'json.response']], function () {
    Route::get('cron-job',[ReminderController::class,'cron_job'])->name('cron-job');
...
Route::get('pre-prayer-notice',[PrayerController::class,'pre_prayer_notice'])->name('pre-prayer-notice');
